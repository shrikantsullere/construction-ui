...
<<<<<<< HEAD
    return (
        <div className="flex flex-col h-full">
            {/* Header */}
            <div className="bg-white border-b border-slate-200 px-6 py-4 flex flex-col gap-4 sticky top-0 z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-slate-800">Skyline Tower</h1>
                        <p className="text-sm text-slate-500">New York, NY • Project ID: #{id || '101'}</p>
                    </div>
...
>>>>>>> 488c77f4b893985aec49f78bac3dece013a19f29
                ${activeTab === tab.id
